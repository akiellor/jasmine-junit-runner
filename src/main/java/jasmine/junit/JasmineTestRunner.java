...
import jasmine.runtime.webdriver.WebDriverBackend;
...
public class JasmineTestRunner extends Runner {
    ...
    public JasmineTestRunner(Class<?> testClass) {
        ...
        this.jasmine = new Jasmine(new WebDriverBackend(configuration, Description.createSuiteDescription(testClass)));
    }
